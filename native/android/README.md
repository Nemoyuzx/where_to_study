...
教学日历和设置均可进入“班车与重要事件查询”。班车使用固定 HTTPS API，只展示当天生效且通过严格校验的双向班次、下一班与发车地点；重要事件复用教学日历的公开 Contest DDL 和校内通知缓存，支持全文/分类筛选、过期切换、DDL 升序和本地收藏，不包含课程作业或自定义日程。学术会议与期刊专题可通过独立会议开关进入教学日历。
