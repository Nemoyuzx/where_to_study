...
应用提供可调整尺寸的原生“今日课程”桌面小组件，直接读取应用私有课表缓存，展示日期、星期、教学周、当前或下一节状态、时间、节次、教室与教师，并按实际高度最多显示 6 门课程。设置页可用虚构示例切换紧凑、标准和展开样式，实时查看课程数量、地点与教师开关效果。课表刷新、账号清除、日期或时区变化以及应用更新后会立即重绘，系统也会定期刷新课程状态；当天没有课程或尚未获取课表时统一显示“今日无课”。
