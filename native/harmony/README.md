...
最新背景主题测试构建为 `0.2.9 (1002025)`：2026-09-09 10:46 +0800 确认 DevEco **仅测试**上传完成，结果页显示云测试通过；没有提交上架审核。低饱和预设同步背景、卡片和控件，并修复实际染色层文字可读性；最终 163 项单元测试、完整 APP 构建、APP/HAP 版本与签名核验通过。设备视觉回归限制保持原记录；详见[测试上传记录](../../docs/release-v0.2.9.md)。
