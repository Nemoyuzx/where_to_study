...
- iOS `0.1.4 (35)` 与 macOS `0.1.4 (34)` 均已收到 App Store Connect 的 `Upload succeeded`；当前等待 Apple 处理。TestFlight 和正式提交选择各平台的最新构建。
...
- App Store Connect 处理完成后，将 iOS build 35 与 macOS build 34 加入内部 TestFlight 群组并在真机验证登录、课表、空教室、日历导入、通知、深浅色和前后台切换。
