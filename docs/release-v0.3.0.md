...
版本矩阵：Android **0.3.0 (51)**，Apple **0.3.0 (94)**，HarmonyOS **0.3.0 (1002031)**；Tauri、Core、CLI、TUI **0.3.0**。最终上传回执在完成后补记，不能把本段准备信息理解为已公开。
...
Android APK：1,148,682 bytes，SHA-256 `02fb94244bd7fea5ee70fc8b40de19ebe40aa76d18aed9b75db2dc09c6feebab`。仅公开 APK，脚本额外生成的 AAB／校验文件不发布。
