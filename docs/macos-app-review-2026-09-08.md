...
同一批身份与支持信息修复已同步到 iOS `0.2.8 (87)`，并于 2026-09-08 完成重新提交，状态为“等待审核”。补齐 iOS 安装名称，验证 iPhone/iPad 中英文路径，更新支持链接、说明和 iPad 真实主页面截图；macOS 审核未变。详见 [iOS 修复与提交记录](ios-app-review-2026-09-08.md)。
