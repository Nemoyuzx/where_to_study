...
| HarmonyOS | `0.2.6 (1002010)` Release 签名 HAP/App 构建、签名摘要验证与 113/113 ArkTS 单元测试通过；DevEco 已上传 AGC、云测试通过并绑定至 0.2.6 发布草稿；GitHub 同步提供签名 APP/HAP，测试邀请码为 `A0IsJpKIcn3` |
