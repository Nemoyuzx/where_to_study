...
这是 **0.3.1 预发布版**，用于体验本轮查询界面优化；GitHub 最新稳定版仍为 0.3.0。
...
包内版本为 **0.3.1**：Android **54**，Apple **98**，HarmonyOS **1002034**。各渠道的完成状态见[构建与上传记录](https://github.com/Nemoyuzx/where_to_study/blob/main/docs/release-v0.3.1-prerelease.md)。
