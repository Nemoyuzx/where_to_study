...
- Android 班车查询的刷新和外链图标恢复为清晰可辨的视觉尺寸，并保留足够点击区域。
- 不改变成绩／考试／作业的获取、登录缓存、隐私和课程提醒规则。

## 下载与测试渠道

包内版本为 **0.3.1**：Android **56**，Apple **99**，HarmonyOS **1002035**。各渠道的完成状态见[构建与上传记录](https://github.com/Nemoyuzx/where_to_study/blob/main/docs/release-v0.3.1-prerelease.md)。
...
- Android shuttle refresh and external-link icons now use legible visual sizes while retaining adequate tap targets.
