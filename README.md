...
| 平台 | 客户端技术 | 发布状态 |
| --- | --- | --- |
| macOS | SwiftUI 原生；另提供 Tauri 2 兼容构建 | `0.1.6 (41)` 正式签名 Universal 构建；公开 GitHub Release 另提供临时签名预览包 |
