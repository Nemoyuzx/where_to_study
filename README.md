...
| 平台 | 客户端技术 | 发布状态 |
| --- | --- | --- |
| macOS | SwiftUI 原生；另提供 Tauri 2 兼容构建 | 正式签名的 Universal build 29 已上传 App Store Connect；公开 GitHub Release 另提供临时签名预览包 |
